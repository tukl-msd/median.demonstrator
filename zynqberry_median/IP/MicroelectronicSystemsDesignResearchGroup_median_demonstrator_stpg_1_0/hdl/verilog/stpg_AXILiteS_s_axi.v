...
localparam
    ...
    ADDR_IER             = 5'h08,
    ADDR_ISR             = 5'h0c,
    ADDR_WIDTH_V_DATA_0  = 5'h10,
    ADDR_WIDTH_V_CTRL    = 5'h14,
    ADDR_HEIGHT_V_DATA_0 = 5'h18,
    ADDR_HEIGHT_V_CTRL   = 5'h1c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_HEIGHT_V_DATA_0)
            int_height_V[11:0] <= (WDATA[31:0] & wmask) | (int_height_V[11:0] & ~wmask);
    end
end
