...
entity ZynqberryMinimalDesign is
  port (
  ...
  attribute CORE_GENERATION_INFO of ZynqberryMinimalDesign : entity is "ZynqberryMinimalDesign,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ZynqberryMinimalDesign,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of ZynqberryMinimalDesign : entity is "ZynqberryMinimalDesign.hwdef";
end ZynqberryMinimalDesign;

architecture STRUCTURE of ZynqberryMinimalDesign is
  component ZynqberryMinimalDesign_processing_system7_0_0 is
  port (
  ...
  end component ZynqberryMinimalDesign_processing_system7_0_0;
...
begin
processing_system7_0: component ZynqberryMinimalDesign_processing_system7_0_0
     port map (
